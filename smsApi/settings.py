...
# and README.rst, a smsApi directory with settings etc (see
...
PROJECT_PATH = os.path.join(PROJECT_ROOT, 'smsApi')
...
SECRET_KEY = '^0()onvmfiatjnii*onsnhql3ekjjwo&!5yk+7z7@mbrt4ds3c'
